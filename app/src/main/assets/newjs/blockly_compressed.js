...
goog.ui.tree.BaseNode.prototype.getRowSafeHtml = function() {
    ...
    a = {
        "class": this.getRowClassName() + ' leftbox'+biaoshi,
        style: a
    };
    console.log(this.getRowClassName());
...
Blockly.onMouseUp_ = function(a) {
    ...
    a.dragMode_ != Blockly.DRAG_NONE && (Blockly.Touch.clearTouchIdentifier(), a.resetDragSurface(), Blockly.Css.setCursor(Blockly.Css.Cursor.OPEN), a.dragMode_ = Blockly.DRAG_NONE, Blockly.Touch.onTouchUpWrapper_ && (Blockly.unbindEvent_(Blockly.Touch.onTouchUpWrapper_), Blockly.Touch.onTouchUpWrapper_ = null), Blockly.onMouseMoveWrapper_ && (Blockly.unbindEvent_(Blockly.onMouseMoveWrapper_), Blockly.onMouseMoveWrapper_ = null))
};
...
Blockly.Workspace.prototype.BlockLength_ = 0;
Blockly.Workspace.prototype.BlockLength = function() {
    Blockly.Workspace.prototype.BlockLength_ = this.topBlocks_.length;
    return Blockly.Workspace.prototype.BlockLength_
};
...
Blockly.Workspace.prototype.deleteVariable = function(a) {
    ...
    if (-1 != c) {
        ...
        var g = this;
        1 < d.length ? Blockly.confirm(Blockly.Msg.DELETE_VARIABLE_CONFIRMATION.replace("%1", d.length).replace("%2", a), function(a) {
            a && b()
        }) : b()
    }
};
...
Blockly.Field.prototype.backdrop = function(a) {
...
Blockly.FieldLabel = function(a, b) {
    this.size_ = new goog.math.Size(0, 20);
    this.class_ = b;
    this.setValue(a)
};
...
Blockly.Options = function(a) {
    ...
    m = "end" === m ? !1 : !0;
    var q = n ? m ? Blockly.TOOLBOX_AT_TOP : Blockly.TOOLBOX_AT_BOTTOM : m == l ? Blockly.TOOLBOX_AT_RIGHT : Blockly.TOOLBOX_AT_LEFT;
    var p = a.scrollbars;
    void 0 === p && (p = f);
    var t = a.css;
    void 0 === t && (t = !0);
...
goog.events.BrowserFeature.TOUCH_ENABLED && (Blockly.Scrollbar.scrollbarThickness = 5);
...
Blockly.Trashcan.prototype.click = function(a) {
    a = this.workspace_.startScrollX - this.workspace_.scrollX;
    var b = this.workspace_.startScrollY - this.workspace_.scrollY;
    Math.sqrt(a * a + b * b) > Blockly.DRAG_RADIUS || (console.log("TODO: Inspect trash."), 0 < Blockly.Workspace.prototype.BlockLength_ && popupDelete())
};
Blockly.utils = {};
...
Blockly.utils.tokenizeInterpolation = function(a) {
    ...
    for (var e = null, f = 0; f < c.length; f++) {
        var g = c[f];
        0 == d ? "%" == g ? ((g = a.join("")) && b.push(g), a.length = 0, d = 1) : a.push(g) : 1 == d ? "%" == g ? (a.push(g), d = 0) : "0" <= g && "9" >= g ? (d = 2, e = g, (g = a.join("")) && b.push(g), a.length = 0) : "{" == g ? d = 3 : (a.push("%", g), d = 0) : 2 == d ? "0" <= g && "9" >= g ? e += g : (b.push(parseInt(e, 10)), f--, d = 0) : 3 == d && ("" == g ? (a.splice(0, 0, "%{"), f--, d = 0) : "}" != g ? a.push(g) : (g = a.join(""), /[a-zA-Z][a-zA-Z0-9_]*/.test(g) ? (d = g.toUpperCase(), (d = goog.string.startsWith(d, "BKY_") ? d.substring(4) : null) && d in Blockly.Msg ? (g = Blockly.utils.tokenizeInterpolation(Blockly.Msg[d]), b = b.concat(g)) : b.push("%{" + g + "}")) : b.push("%{" + g + "}"), d = a.length = 0))
    }(g = a.join("")) && b.push(g);
    c = [];
    for (f = a.length = 0; f < b.length; ++f) "string" == typeof b[f] ? a.push(b[f]) : ((g = a.join("")) && c.push(g), a.length = 0, c.push(b[f]));
    (g = a.join("")) && c.push(g);
    a.length = 0;
    return c
};
...
Blockly.Xml.workspaceToDomiOS = function(a, b) {
    for (var c = goog.dom.createDom("xml"), d = a.getTopBlocks(!0), e = 0, f; f = d[e]; e++) c.appendChild(Blockly.Xml.blockToDomWithXY(f, b));
    getXmlToSave(c)
};
...
Blockly.Xml.domToTextiOS = function(a) {
    a = (new XMLSerializer).serializeToString(a);
    getXmlToSave(a)
};
Blockly.Xml.domToTextAndroid = function(a) {
    var b = new XMLSerializer;
    window.JSFunc.domToText(b.serializeToString(a))
};
Blockly.Xml.domToTextAndroidSave = function(a) {
    var b = new XMLSerializer;
    window.JSFunc.domToTextSave(b.serializeToString(a))
};
...
Blockly.ZoomControls_ = function(a) {
    this.workspace_ = a
};
...
Blockly.WorkspaceSvg.prototype.scrollCenter2 = function() {
    if (this.scrollbar) {
        var a = this.getMetrics(),
            b = (a.viewWidth - 168) / 2;
        this.flyout_ && (b -= this.flyout_.width_ / 2);
        this.scrollbar.set(b, a.viewHeight / 1.3)
    }
};
...
Blockly.WorkspaceSvg.setTopLevelWorkspaceMetrics_ = function(a) {
    ...
    this.translate(a, b);
    this.options.gridPattern && (this.options.gridPattern.setAttribute("x", a), this.options.gridPattern.setAttribute("y", b), (goog.userAgent.IE || goog.userAgent.EDGE) && this.updateGridPattern_())
};
            ...
            do
                if (e = !1, "string" == typeof f) h = new Blockly.FieldLabel(f);
                    ...
                    case "input_dummy":
                        ...
                        break;
                    case "field_label":
                        h = new Blockly.FieldLabel(f.text, f["class"]);
                        break;
                    case "field_input":
    ...
    if (!this.workspace.options.readOnly)
        if (this.isInFlyout) "touchstart" == a.type && Blockly.utils.isRightButton(a) && (Blockly.Flyout.blockRightClick_(a, this), a.stopPropagation(), a.preventDefault());
            ...
            if (Blockly.utils.isRightButton(a)) {
                if ("air_start" == this.type) return !1;
                Blockly.duplicate_(this)
...
Blockly.BlockSvg.prototype.setHighlighted = function(a) {
    this.rendered && (a ? (this.svgPath_.setAttribute("filter", "url(#" + this.workspace.options.embossFilterId + ")"), this.svgPathLight_.style.display = "none") : (this.svgPath_.removeAttribute("filter"), delete this.svgPathLight_.style.display))
};
...
Blockly.BlockSvg.NOTCH_WIDTH = 55;
Blockly.BlockSvg.CORNER_RADIUS = 6;
...
Blockly.BlockSvg.TAB_PATH_DOWN = "v 10 c 0,10 -" + Blockly.BlockSvg.TAB_WIDTH + ",-8 -" + Blockly.BlockSvg.TAB_WIDTH + ",7.5 s " + Blockly.BlockSvg.TAB_WIDTH + ",-2.5 " + Blockly.BlockSvg.TAB_WIDTH + ",7.5";
Blockly.BlockSvg.TAB_PATH_DOWN2 = "v 3.5 c 0,10 -" + Blockly.BlockSvg.TAB_WIDTH + ",-8 -" + Blockly.BlockSvg.TAB_WIDTH + ",7.5 s " + Blockly.BlockSvg.TAB_WIDTH + ",-2.5 " + Blockly.BlockSvg.TAB_WIDTH + ",7.5";
...
Blockly.BlockSvg.prototype.renderCompute_ = function(a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, l = this.getInputsInline() && !this.isCollapsed(), n = 0, m; m = b[n]; n++)
        if (m.isVisible()) {
            ...
            else k = m.type, q = [], q.type = l && m.type != Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.INLINE : m.type, q.height = 0, c.push(q);
            q.push(m);
            ...
            q.type != Blockly.BlockSvg.INLINE && (q.type == Blockly.NEXT_STATEMENT ? (g = !0, e = Math.max(e, m.fieldWidth)) : (q.type == Blockly.INPUT_VALUE ? f = !0 : q.type == Blockly.DUMMY_INPUT && (h = !0), d = Math.max(d, m.fieldWidth)))
        }
    for (a = 0; q = c[a]; a++)
...
Blockly.BlockSvg.prototype.renderDraw_ = function(a, b) {
    ...
    c = [];
    var f = [];
    this.renderDrawTop_(d, c, b.rightEdge, b);
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function(a, b, c, d, e, f) {
    for (var g, h, k, l, n = 0, m, q = 0, p; p = e[q]; q++) {
        ...
        if (this.isCollapsed()) l = p[0], k = h, h = n, this.renderFields_(l.fieldRow, k, h), a.push(Blockly.BlockSvg.JAGGED_TEETH), b.push("h 8"), l = p.height - Blockly.BlockSvg.JAGGED_TEETH_HEIGHT, a.push("v", l), this.RTL && (b.push("v 3.9 l 7.2,3.4 m -14.5,8.9 l 7.3,3.5"), b.push("v", l - .7)), this.width += Blockly.BlockSvg.JAGGED_TEETH_WIDTH;
            ...
            for (g = 0; l = p[g]; g++) k = h, h = n, p.thicker && (h += Blockly.BlockSvg.INLINE_PADDING_Y), h = this.renderFields_(l.fieldRow, k, h), l.type != Blockly.DUMMY_INPUT && (h += l.renderWidth + Blockly.BlockSvg.SEP_SPACE_X), l.type == Blockly.INPUT_VALUE && (c.push("M", h - Blockly.BlockSvg.SEP_SPACE_X + "," + (n + Blockly.BlockSvg.INLINE_PADDING_Y + 6)), c.push("a", "6,6 0 0,0 -6,-6"), c.push("h", Blockly.BlockSvg.TAB_WIDTH - 2 - l.renderWidth + 12), c.push("a", "6,6 0 0,0 -6,6"), c.push(Blockly.BlockSvg.TAB_PATH_DOWN2), c.push("v", l.renderHeight - 10.5 - Blockly.BlockSvg.TAB_HEIGHT), c.push("a", "6,6 0 0,0 6,6"), c.push("h", l.renderWidth + 2 - Blockly.BlockSvg.TAB_WIDTH - 12), c.push("a", "6,6 0 0,0 6,-6"), c.push("z"), this.RTL ? (d.push("M", h - Blockly.BlockSvg.SEP_SPACE_X - 2.5 + Blockly.BlockSvg.TAB_WIDTH - l.renderWidth + "," + (n + Blockly.BlockSvg.INLINE_PADDING_Y + .5)), d.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL), d.push("v", l.renderHeight - Blockly.BlockSvg.TAB_HEIGHT + 2.5), d.push("h", l.renderWidth - Blockly.BlockSvg.TAB_WIDTH + 2)) : (d.push("M", h - Blockly.BlockSvg.SEP_SPACE_X - 5.5 + "," + (n + Blockly.BlockSvg.INLINE_PADDING_Y + .5)), d.push("a", "6,6 0 0,1 6,6"), d.push("v", l.renderHeight - 12.5), d.push("a", "6,6 0 0,1 -6,6"), d.push("h", Blockly.BlockSvg.TAB_WIDTH - 2 - l.renderWidth + 12), d.push("a", "6,6 0 0,1 -6,-6"), d.push("M", h - l.renderWidth - Blockly.BlockSvg.SEP_SPACE_X + .9 + "," + (n + Blockly.BlockSvg.INLINE_PADDING_Y + Blockly.BlockSvg.TAB_HEIGHT + 4.2)), d.push("l", .46 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1")), k = this.RTL ? -h - Blockly.BlockSvg.TAB_WIDTH + Blockly.BlockSvg.SEP_SPACE_X + l.renderWidth + 1 : h + Blockly.BlockSvg.TAB_WIDTH - Blockly.BlockSvg.SEP_SPACE_X - l.renderWidth - 1, m = n + Blockly.BlockSvg.INLINE_PADDING_Y + 1, l.connection.setOffsetInBlock(k, m));
            h = Math.max(h, e.rightEdge);
            this.width = Math.max(this.width, h);
            a.push("H", h - 6);
            a.push("A", "6,6 0 0,1" + h + ",6");
            b.push("H", h - 5.5);
            a.push("v", p.height - 12);
            a.push("A", "6,6 0 0,1 " + (h - 6) + "," + p.height);
            this.RTL && b.push("v", p.height - 1)
        } else p.type == Blockly.INPUT_VALUE ? (l = p[0], k = h, h = n, l.align != Blockly.ALIGN_LEFT && (g = e.rightEdge - l.fieldWidth - Blockly.BlockSvg.TAB_WIDTH - 2 * Blockly.BlockSvg.SEP_SPACE_X, l.align == Blockly.ALIGN_RIGHT ? k += g : l.align == Blockly.ALIGN_CENTRE && (k += g / 2)), this.renderFields_(l.fieldRow, k, h), "lists_create_with2" == this.type && e.length != q + 1 ? (a.push(Blockly.BlockSvg.TAB_PATH_DOWN2), g = p.height - Blockly.BlockSvg.TAB_HEIGHT, g += 1.5, a.push("v", g)) : ("lists_create_with2" == this.type && e.length == q + 1 ? (a.push(Blockly.BlockSvg.TAB_PATH_DOWN2), g = p.height - Blockly.BlockSvg.TAB_HEIGHT, g -= 4.5) : (a.push("a", "6,6 0 0,1 6,6"), a.push(Blockly.BlockSvg.TAB_PATH_DOWN2), g = p.height - Blockly.BlockSvg.TAB_HEIGHT, g -= 10.5), a.push("v", g), a.push("a", "6,6 0 0,1 -6,6")), this.RTL ? (b.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL), b.push("v", g + .5)) : (b.push("M", e.rightEdge - 5 + "," + (n + Blockly.BlockSvg.TAB_HEIGHT + 4.2)), b.push("l", .46 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1")), k = this.RTL ? -e.rightEdge - 1 : e.rightEdge + 1, l.connection.setOffsetInBlock(k, n), l.connection.isConnected() && (this.width = Math.max(this.width, e.rightEdge + l.connection.targetBlock().getHeightWidth().width - Blockly.BlockSvg.TAB_WIDTH + 1))) : p.type == Blockly.DUMMY_INPUT ? (l = p[0], k = h, h = n, l.align != Blockly.ALIGN_LEFT && (g = e.rightEdge - l.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X, e.hasValue && (g -= Blockly.BlockSvg.TAB_WIDTH), l.align == Blockly.ALIGN_RIGHT ? k += g : l.align == Blockly.ALIGN_CENTRE && (k += g / 2)), this.renderFields_(l.fieldRow, k, h), "lists_create_with2" == this.type ? (a.push("A", "6,6 0 0,1 " + this.width + ",6"), a.push("v", p.height)) : (a.push("A", "6,6 0 0,1 " + this.width + ",6"), a.push("v", p.height - 12), a.push("A", "6,6 0 0,1 " + (this.width - 6) + "," + p.height)), this.RTL && b.push("v", p.height - 1)) : p.type == Blockly.NEXT_STATEMENT && (l = p[0], 0 == q && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y), this.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), n += Blockly.BlockSvg.SEP_SPACE_Y), k = h, h = n, l.align != Blockly.ALIGN_LEFT && (g = e.statementEdge - l.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X, l.align == Blockly.ALIGN_RIGHT ? k += g : l.align == Blockly.ALIGN_CENTRE && (k += g / 2)), this.renderFields_(l.fieldRow, k, h), h = e.statementEdge + Blockly.BlockSvg.NOTCH_WIDTH, a.push("H", h), a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER), a.push("v", p.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER), a.push("H", e.rightEdge - 6), this.RTL ? (b.push("M", h - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (n + Blockly.BlockSvg.DISTANCE_45_OUTSIDE)), b.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER_HIGHLIGHT_RTL), b.push("v", p.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_RTL), b.push("H", e.rightEdge - .5)) : (b.push("M", h - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (n + p.height - Blockly.BlockSvg.DISTANCE_45_OUTSIDE)), b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_LTR), b.push("H", e.rightEdge - 6.5)), k = this.RTL ? -h : h + 1, l.connection.setOffsetInBlock(k, n + 1), l.connection.isConnected() && (this.width = Math.max(this.width, e.statementEdge + l.connection.targetBlock().getHeightWidth().width)), q == e.length - 1 || e[q + 1].type == Blockly.NEXT_STATEMENT) && (a.push("a", "6,6 0 0,1 6,6"), a.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 12), a.push("a", "6,6 0 0,1 -6,6"), this.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), n += Blockly.BlockSvg.SEP_SPACE_Y);
        n += p.height
    }
...
Blockly.BlockSvg.prototype.renderDrawBottom_ = function(a, b, c) {
    ...
    this.squareBottomLeftCorner_ ? (a.push("H", Blockly.BlockSvg.CORNER_RADIUS), a.push("a", Blockly.BlockSvg.CORNER_RADIUS + "," + Blockly.BlockSvg.CORNER_RADIUS + " 0 0,1 -" + Blockly.BlockSvg.CORNER_RADIUS + ",-" + Blockly.BlockSvg.CORNER_RADIUS), this.RTL || b.push("M", "0.5," + (c - 5.5))) : (a.push("H", Blockly.BlockSvg.CORNER_RADIUS), a.push("a", Blockly.BlockSvg.CORNER_RADIUS + "," + Blockly.BlockSvg.CORNER_RADIUS + " 0 0,1 -" + Blockly.BlockSvg.CORNER_RADIUS + ",-" + Blockly.BlockSvg.CORNER_RADIUS), this.RTL || (b.push("M", Blockly.BlockSvg.DISTANCE_45_INSIDE + "," + (c - Blockly.BlockSvg.DISTANCE_45_INSIDE)), b.push("A", Blockly.BlockSvg.CORNER_RADIUS - .5 + "," + (Blockly.BlockSvg.CORNER_RADIUS - .5) + " 0 0,1 0.5," + (c - Blockly.BlockSvg.CORNER_RADIUS))))
};
Blockly.BlockSvg.prototype.renderDrawLeft_ = function(a, b) {
    this.outputConnection ? (this.outputConnection.setOffsetInBlock(0, 0), a.push("V", Blockly.BlockSvg.TAB_HEIGHT + 3), a.push("c 0,-10 -" + Blockly.BlockSvg.TAB_WIDTH + ",8 -" + Blockly.BlockSvg.TAB_WIDTH + ",-7.5 s " + Blockly.BlockSvg.TAB_WIDTH + ",2.5 " + Blockly.BlockSvg.TAB_WIDTH + ",-7.5"), this.RTL ? (b.push("M", -.25 * Blockly.BlockSvg.TAB_WIDTH + ",8.4"), b.push("l", -.45 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1")) : (b.push("V", Blockly.BlockSvg.TAB_HEIGHT + 1.5), b.push("m", -.92 * Blockly.BlockSvg.TAB_WIDTH + ",-0.5 q " + -.19 * Blockly.BlockSvg.TAB_WIDTH + ",-5.5 0,-11"), b.push("m", .92 * Blockly.BlockSvg.TAB_WIDTH + ",1 V 5.5 H 0.5")), this.width += Blockly.BlockSvg.TAB_WIDTH) : this.RTL || (this.squareTopLeftCorner_ ? b.push("V", 5.5) : b.push("V", Blockly.BlockSvg.CORNER_RADIUS));
    a.push("z")
};
Blockly.Events = {};
...
Blockly.FieldTextInput.prototype.showEditor_ = function(a) {
    this.sourceBlock_.clickFunc && this.sourceBlock_.clickFunc(this)
};
...
Blockly.FieldColour.prototype.rgbColor = function(a) {
    var b = a.substring(1);
    a = parseInt(b.substring(2, 0), 16);
    var c = parseInt(b.substring(4, 2), 16);
...
Blockly.FieldDropdown.prototype.dropdownFunc = function(a, b) {
    Blockly.Field.prototype.backdrop(b)
};
...
Blockly.FieldDropdown.prototype.trimOptions_ = function() {
    ...
    if (goog.isArray(a) && !(2 > a.length)) {
        ...
        d = Blockly.utils.shortestStringLength(b);
        var e = Blockly.utils.commonWordPrefix(b, d),
            f = Blockly.utils.commonWordSuffix(b, d);
        if ((e || f) && !(d <= e + f)) {
...
Blockly.Variables.flyoutCategory = function(a) {
    var b = Blockly.Variables.allVariables(a);
    b.sort(goog.string.caseInsensitiveCompare);
    goog.array.remove(b, Blockly.Msg.VARIABLES_DEFAULT_NAME);
    b.unshift(Blockly.Msg.VARIABLES_DEFAULT_NAME);
    var c = [];
    if (Blockly.Blocks.variables_declare) {
        var d = goog.dom.createDom("block");
        d.setAttribute("type", "variables_declare");
        c.push(d)
    }
    for (var e = 0; e < b.length; e++) 0 != e && (Blockly.Blocks.variables_set && (d = goog.dom.createDom("block"), d.setAttribute("type", "variables_set"), Blockly.Blocks.variables_get && d.setAttribute("gap", 8), a = goog.dom.createDom("field", null, b[e]), a.setAttribute("name", "VAR"), d.appendChild(a), c.push(d)), Blockly.Blocks.variables_get && (d = goog.dom.createDom("block"), d.setAttribute("type", "variables_get"), Blockly.Blocks.variables_set && d.setAttribute("gap", 24), a = goog.dom.createDom("field", null, b[e]), a.setAttribute("name", "VAR"), d.appendChild(a), c.push(d)));
    return c
};
...
Blockly.Variables.rename = function(a) {
    a = a.replace(/^[\s\xa0]+|[\s\xa0]+$/g, "");
    var b = Blockly.Variables.findLegalName(a, this.sourceBlock_),
        c = this.text_;
    if (c != a && c != b) {
...
Blockly.Variables.findLegalName = function(a, b) {
    ...
    for (; !Blockly.Variables.isLegalName_(a, b.workspace, b);) {
        var c = a.match(/^(.*?)(\d+)$/);
        a = c ? c[1] + (parseInt(c[2], 10) + 1) : a + "2"
    }
    return a
};
Blockly.Variables.isLegalName_ = function(a, b, c) {
    b = b.getAllBlocks();
    for (var d = 0; d < b.length; d++)
        if (b[d] != c && b[d].getVariablesDef) {
            var e = b[d].getVariablesDef();
...
Blockly.Generator.prototype.workspaceToCode = function(a) {
    ...
    for (var c = 0, d; d = a[c]; c++) {
        var e = "";
        "air_start" == a[c].type && (e = this.blockToCode(d));
...
Blockly.Generator.prototype.workspaceToCodeAndroid = function(a) {
    a || (console.warn("No workspace specified in workspaceToCode call.  Guessing."), a = Blockly.getMainWorkspace());
    var b = [];
    this.init(a);
    a = a.getTopBlocks(!0);
    ...
    b = b.replace(/\n\s+$/, "\n");
    b = b.replace(/[ \t]+\n/g, "\n");
    window.JSFunc.workspaceToCode(b)
};
...
Blockly.Flyout.prototype.createDom = function(a) {
    ...
    this.svgBackground2_ = Blockly.utils.createSvgElement("path", {
        "class": "blocklyFlyoutBackground2"
    }, this.svgGroup_);
...
Blockly.Flyout.prototype.getMetrics_ = function() {
    ...
    } else c = 5, d = this.height_ - 2 * this.SCROLLBAR_PADDING, e = this.width_,
...
Blockly.Flyout.prototype.position = function() {
    if (this.isVisible()) {
        ...
        if (a) {
            ...
            this.horizontalLayout_ ? this.width_ = a.viewWidth : this.height_ = a.viewHeight - 10;
            this.svgGroup_.setAttribute("width", this.width_);
            this.svgGroup_.setAttribute("height", this.height_);
            this.svgGroup_.style.transform = "translate(" + (b + 4) + "px," + (c + 5) + "px)";
...
Blockly.Flyout.prototype.setBackgroundPathVertical_ = function(a, b) {
    ...
    d = ["M " + (c ? d : 0) + ",8"];
    d.push("a", "8,8 0 0,1 8,-8");
    d.push("h", c ? -a : a - 8);
    d.push("a", this.CORNER_RADIUS, this.CORNER_RADIUS, 0, 0, c ? 0 : 1, c ? -this.CORNER_RADIUS : this.CORNER_RADIUS, this.CORNER_RADIUS);
    d.push("v", Math.max(0, b - 10));
    d.push("a", this.CORNER_RADIUS, this.CORNER_RADIUS, 0, 0, c ? 0 : 1, c ? this.CORNER_RADIUS : -this.CORNER_RADIUS, this.CORNER_RADIUS);
    d.push("h", c ? a : -a + 8);
    d.push("a", "8,8 0 0,1 -8,-8");
    d.push("z");
    c = ["M 0,8 a 8,8 0 0,1 8,-8"];
    c.push("v", Math.max(0, b + 6));
    c.push("a", "8,8 0 0,1 -8,-8");
    c.push("Z");
    this.svgBackground_.setAttribute("d", d.join(" "));
    this.svgBackground2_.setAttribute("d", c.join(" "))
};
...
Blockly.Toolbox.prototype.addColour_ = function(a) {
    for (var b = (a || this.tree_).getChildren(), c = 0, d; d = b[c]; c++) {
        ...
        e && (a = this.hasColours_ ? "0px solid " + (d.hexColour || "#ddd") : "none", this.workspace_.RTL ? e.style.borderRight = a : e.style.borderLeft = a);
        this.addColour_(d)
    }
};
...
Blockly.onKeyDown_ = function(a) {
    if (!Blockly.mainWorkspace.options.readOnly && !Blockly.utils.isTargetInput(a)) {
        ...
        else if (a.altKey || a.ctrlKey || a.metaKey) Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() && (67 == a.keyCode ? (Blockly.hideChaff(), Blockly.copy_(Blockly.selected)) : 88 == a.keyCode && (Blockly.copy_(Blockly.selected), b = !0)), 86 == a.keyCode ? Blockly.clipboardXml_ && (Blockly.Events.setGroup(!0), Blockly.clipboardSource_.paste(Blockly.clipboardXml_), Blockly.Events.setGroup(!1)) : 90 == a.keyCode && (Blockly.hideChaff(), Blockly.mainWorkspace.undo(a.shiftKey));
